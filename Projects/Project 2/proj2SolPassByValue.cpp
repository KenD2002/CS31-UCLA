...
string promptForDays( );
string promptForFacilities( );
string promptForAutoPay( );
string promptForPaperless( );
...
int main()
{
    ...
    type = promptForType( );
    days =  promptForDays( );
    facilities =  promptForFacilities( );
    autopay =  promptForAutoPay( );
    paperless = promptForPaperless( );
